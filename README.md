# Sentinel: Human-Centric Scam Early Warning Network
...
```
*Note: The terminal will display a link (e.g., `http://127.0.0.1:8000`). **Do not click this link.** This is the raw data engine, not the user interface.*
